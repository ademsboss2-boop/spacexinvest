...
export default function FeaturedOpportunities() {
  ...
  return (
    <section id="opportunities" className="w-full bg-white text-black py-24">
      <Container>
        <div className="max-w-6xl mx-auto">
          <div className="text-center">
            <h2 className="text-xl md:text-2xl font-medium tracking-tight">Featured Opportunities</h2>
            <p className="mt-3 text-sm text-black/60">Selected mission-aligned offerings with clear entry points and transparent terms.</p>
          </div>

          <div className="mt-12 divide-y divide-black/8">
            {SAMPLE.map((s, i) => (
              <motion.div key={s.id} initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: reduced ? 0 : i * 0.06, duration: 0.42 }} className="py-6">
